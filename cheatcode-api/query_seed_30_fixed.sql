...
insert into patterns (id, name, description) values
  ('a1b2c3d4-0000-0000-0000-000000000002', 'Two Pointer', 'Two indices moving toward or away from each other. Eliminates nested loops. O(n) instead of O(n²).'),
  ('a1b2c3d4-0000-0000-0000-000000000004', 'Binary Search', 'Eliminate half the search space each step. Requires sorted input or monotonic condition. O(log n).'),
  ('a1b2c3d4-0000-0000-0000-000000000005', 'Dynamic Programming', 'Break into overlapping subproblems. Store results to avoid recomputation. Top-down or bottom-up.'),
...
('Two Sum II — Sorted Array', 'Amazon', 'Amazon SDE2', 'Two Pointer', 'a1b2c3d4-0000-0000-0000-000000000002', 1,
'[
...
('Valid Palindrome', 'Meta', 'Meta E4', 'Two Pointer', 'a1b2c3d4-0000-0000-0000-000000000002', 1,
'[
...
('Container With Most Water', 'Google', 'Google L4', 'Two Pointer', 'a1b2c3d4-0000-0000-0000-000000000002', 2,
'[
...
('3Sum', 'Meta', 'Meta E5', 'Two Pointer', 'a1b2c3d4-0000-0000-0000-000000000002', 2,
'[
...
('Move Zeroes', 'Facebook', 'Meta E3', 'Two Pointer', 'a1b2c3d4-0000-0000-0000-000000000002', 1,
'[
...
('Trapping Rain Water', 'Amazon', 'Amazon L5', 'Two Pointer', 'a1b2c3d4-0000-0000-0000-000000000002', 3,
'[
...
('Binary Search', 'Google', 'Google L3', 'Binary Search', 'a1b2c3d4-0000-0000-0000-000000000004', 1,
'[
...
('Find Minimum in Rotated Sorted Array', 'Amazon', 'Amazon L4', 'Binary Search', 'a1b2c3d4-0000-0000-0000-000000000004', 2,
'[
...
('Search in Rotated Sorted Array', 'Meta', 'Meta E5', 'Binary Search', 'a1b2c3d4-0000-0000-0000-000000000004', 2,
'[
  {"text": "function search(nums, target) {", "is_blank": false},
  {"text": "  let left = 0, right = nums.length - 1", "is_blank": false},
  {"text": "", "is_blank": false},
...
('Koko Eating Bananas', 'Google', 'Google L5', 'Binary Search', 'a1b2c3d4-0000-0000-0000-000000000004', 2,
'[
...
('First Bad Version', 'Meta', 'Meta E3', 'Binary Search', 'a1b2c3d4-0000-0000-0000-000000000004', 1,
'[
...
('Search a 2D Matrix', 'Amazon', 'Amazon SDE2', 'Binary Search', 'a1b2c3d4-0000-0000-0000-000000000004', 2,
'[
...
('Climbing Stairs', 'Amazon', 'Amazon SDE1', 'Dynamic Programming', 'a1b2c3d4-0000-0000-0000-000000000005', 1,
'[
...
('House Robber', 'Amazon', 'Amazon SDE2', 'Dynamic Programming', 'a1b2c3d4-0000-0000-0000-000000000005', 2,
'[
...
('Coin Change', 'Amazon', 'Amazon L5', 'Dynamic Programming', 'a1b2c3d4-0000-0000-0000-000000000005', 2,
'[
...
('Longest Increasing Subsequence', 'Google', 'Google L5', 'Dynamic Programming', 'a1b2c3d4-0000-0000-0000-000000000005', 2,
'[
...
('Maximum Product Subarray', 'Amazon', 'Amazon L4', 'Dynamic Programming', 'a1b2c3d4-0000-0000-0000-000000000005', 2,
'[
...
('Word Break', 'Google', 'Google L4', 'Dynamic Programming', 'a1b2c3d4-0000-0000-0000-000000000005', 3,
'[
